...
;pug_debug_line = 10;pug_debug_filename = "src\u002Fpug\u002Findex.pug";
pug_html = pug_html + "svg{width:100%;height:100%;background:rgba(0,0,0,0.1)}.pdl-layout\u003E[data-type=layout]{display:grid;grid-template-columns:6em 1fr 12em;grid-template-rows:1fr 2em 4em}.pdl-layout .bg-secondary{grid-column:3;grid-row:1\u002Fspan 2}.pdl-layout .bg-success{grid-column:1\u002Fspan 3;grid-row:3}\u003C\u002Fstyle\u003E\u003C\u002Fhead\u003E";
